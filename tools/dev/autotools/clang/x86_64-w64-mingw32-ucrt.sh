...
CMAKE_TOOLCHAIN_FILE="${MINGW_HOME}/build/cmake/clang/${CROSS_COMPILE_TRIPLET}-ucrt.cmake"

CC="${MINGW_HOME}/bin/${CROSS_COMPILE_TRIPLET}-ucrt-clang"
CXX="${MINGW_HOME}/bin/${CROSS_COMPILE_TRIPLET}-ucrt-clang++"
